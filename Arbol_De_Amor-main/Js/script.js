...
function showCountdown() {
  ...
  let startDate = startParam ? new Date(startParam + 'T00:00:00') : new Date('2024-12-09T00:00:00'); 
  let eventDate = eventParam ? new Date(eventParam + 'T00:00:00') : new Date('2025-06-09T00:00:00');
  ...
  function update() {
    ...
    container.innerHTML =
      ...
      `Nuestro aniversario de 6 meses: <b>${eventDays}d ${eventHours}h ${eventMinutes}m ${eventSeconds}s</b>`;
